...
## Projects
### 1. [persian_summarization_dataset](https://github.com/erfan-mahdavi/persian_summarization_dataset)
A notebook implementing a pipeline for creating a Persian text summarization dataset, encompassing data acquisition, cleaning, clustering, summary generation using a Persian MT5 model, and evaluation with ROUGE metrics.

### 2. [VAE/CVAE Latent Space Visualization](https://github.com/erfan-mahdavi/vae-cvae-project)
...
### 4. [Tomato/Apple Recognizer](https://github.com/erfan-mahdavi/tomato-apple-recognizer)
...
### 5. [snake_game](https://github.com/erfan-mahdavi/snake_game)
...
### 6. [DataBase_MovieReviewProject](https://github.com/erfan-mahdavi/DataBase_movieReviewProject)
